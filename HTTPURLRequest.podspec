...
Pod::Spec.new do |spec|
  ...
  spec.name         = "HTTPURLRequest"
  spec.version      = "0.0.1"
  spec.summary      = "HTTPURLRequest is an easy way of an HTTP networking in Swift."
  ...
  spec.homepage     = "https://github.com/HTTPURLRequest/"
  ...
  spec.source       = { :git => "https://github.com/HTTPURLRequest/HTTPURLRequest.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Sources/HTTPURLRequest/**/*.{h,m,swift}"
